...
export default async function FinancingPage({ searchParams }: PageProps<"/financing">) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <h1 className="font-display text-3xl font-bold text-neutral-900">Finance Info</h1>
      ...
      <div className="space-y-6 text-neutral-700">
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <h2 className="font-display text-lg font-bold text-neutral-900">Two Prices, No Surprises</h2>
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <h2 className="font-display text-lg font-bold text-neutral-900">How Financing Works</h2>
          <p className="mt-2 text-sm">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-6">
          <h2 className="font-display text-lg font-bold text-neutral-900">Ready to Get Started?</h2>
          <p className="mt-2 text-sm">
            Browse our current{" "}
      ...
      <div id="apply" className="mt-10 scroll-mt-24">
        <h2 className="font-display text-2xl font-bold text-neutral-900">Apply for Financing</h2>
