  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="space-y-6 text-sm text-neutral-700">
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-neutral-900">Information We Collect</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-neutral-900">How We Use It</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-neutral-900">Cookies</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-neutral-900">Contact Us</h2>
          <p className="mt-2">
