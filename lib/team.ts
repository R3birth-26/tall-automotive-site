...
export const team: TeamMember[] = [
  {
    ...
    bio: [
      "Justin is a bright young technician who brings a positive attitude and a smile wherever he goes. His friendly personality and strong work ethic make him a valued member of the Tall Equipment and Machinery team.",
  ...
  },
  {
    ...
    bio: [
      "Josh Tall is the owner and operator of Tall Equipment and Machinery. With nearly 20 years of experience in the automotive repair industry, Josh combines hands-on expertise with a strong educational background, holding college degrees in Business Science and Automotive Technology.",
